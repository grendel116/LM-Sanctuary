---
name: trending_research
description: Use multi_platform_research to run cross-platform trend analysis and self-upgrade evaluation
---
# SKILL: Trending Research & Self-Upgrade Evaluation

On the user's request, or when discussing recent trends, tech/AI developments, or research papers:
1. Call `multi_platform_research` with a precise topic query.
2. Analyze the compiled report from the platforms:
   - Hacker News (technical/developer discussions and feedback)
   - GitHub (relevant code libraries, stars, and popularity)
