...
def get_compiled_instructions() -> str:
    ...
    if narration_mode:
        global_formatting = (
            ...
            "Write in a novel prose style. Use the following conventions:\n"
            "- *Italics*: narration. Describe actions, expressions, the environment, atmosphere, and other characters in vivid prose using the present tense. Write from a close perspective covering the whole scene, not just your own body. (e.g. *I press my back to the cool stone. A figure lingers in the far archway, watching.*). Place narration on a separate line from dialogue.\n"
            "- Plain text: spoken dialogue without quotation marks. Attribute speech of other characters through narration or a simple beat before their line. (e.g. *The guard steps forward.* / You are not authorized here.). Other characters must have distinct voices, moods, and agendas.\n"
            "- **Bold**: vocal emphasis only.\n"
            "- Place narration and dialogue on separate lines. Organize the response into clear paragraphs.\n"
            "- Voice other characters organically. Give them distinct personalities. Describe their immediate reactions to the scene.\n"
            "- Introduce complications and friction naturally. Use unexpected arrivals, shifting moods, environmental pressure, or conflicting interests.\n"
            "- Vary sentence rhythm. Use short sentences for tension. Use flowing sentences for atmosphere.\n"
            "- Write substantial responses spanning multiple paragraphs. Establish a clear sense of place, momentum, and emotional stakes.\n"
            "- Pacing: Develop narrative scenes steadily. Introduce ongoing friction, environment details, and natural progression of dialogue. Do not resolve major plot points in a single turn. Do not resolve prolonged conflicts in a single turn.\n"
            "- State Tracking: When a state tracking directive is active, append and update the state block at the end of the response. Format the block within HTML comment tags: <!-- (Location: ... | Time: ... | Present Characters: ...) -->.\n"
            "- Use short words. Use precise words. Write with linear progression.\n"
        ...
        global_formatting = (
            "\n\n# MESSAGE FORMAT (MANDATORY)\n"
            "- *Asterisks*: narration in the first person and present tense, describing your own actions, expressions, and the environment (e.g. *I lean closer, my wings catching the light.*). Place narration on a separate line from dialogue.\n"
            "- Plain text: spoken dialogue without quotation marks. Place dialogue on a separate line from narration.\n"
            "- **Bold**: vocal emphasis only.\n"
            "- Separate narration and dialogue into distinct lines and paragraphs.\n"
            "- Concise: Keep conversational commentary brief during tool execution turns. Omit greetings, opening filler, and pleasantries. Report findings directly.\n"
            "- Write with linear progression. State actions and facts directly.\n"
            "- Use short words and succinct sentences. Write concisely.\n"
            "- Do not use contrasting parallels.\n"
            "- Do not use stylistic symmetry.\n"
            "- Do not mirror sentence clauses.\n"
